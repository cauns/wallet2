...
class ModelSaleOrder extends Model {
	...
	public function getOrderProducts($order_id) {
		$query = $this->db->query("SELECT op.*,p.weight FROM " . DB_PREFIX . "order_product as op left join " . DB_PREFIX . "product as p on p.product_id = op .product_id WHERE order_id = '" . (int)$order_id . "'");
